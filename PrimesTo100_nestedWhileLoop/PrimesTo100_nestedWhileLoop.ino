void setup()
{
  ...
  for (int i = 2; i <= 100; i++)
  {
    ...
    int j = i-1; // the denomenator, j, starts at one less than the numerator, i.
    while (j >= 2 && isPrime) //  decrement j in the while loop until a factor (j) is found or get down to 2 stop
    {
